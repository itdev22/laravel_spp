...
@section('content')
    ...
    <div class="row">
        <div class="col-lg">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('siswa.pembayaran-tagihan.proses-bayar', $siswa->nisn) }}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-3">
...
@push('js')
    ...
    <script>
        ...
        $(document).on("change", "#tagihansiswa_id", function() {
            ...
            $.ajax({
                url: "/siswa/tagihan/pembayaran/tagihan/" + id + "/" + idSiswa,
                method: "GET",
                success: function(response) {
                    ...
                    $(function() {
                        ...
                        var table = $("#dataTable2").DataTable({
                            ...
                            serverSide: true,
                            "responsive": true,
                            ajax: "{{ url('/siswa/tagihan/pembayaran/list-pembayaran-tagihan') }}" +
                                "/" +
                                nisn +
                                "/" + tagihansiswa_id,
                            columns: [{
