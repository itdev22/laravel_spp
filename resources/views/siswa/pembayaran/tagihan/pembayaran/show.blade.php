...
@endpush
@section('content_title', 'Pembayaran Tagihan Tahun '.$spp->tahun)
@section('content')
<x-alert></x-alert>
<div class="row">
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <a href="{{ route('siswa.pembayaran-tagihan.index') }}" class="btn btn-danger btn-sm">
      ...
      <div class="card-body">
        ...
        <div class="alert alert-danger" role="alert">
          ...
          <p>Pembayaran Tagihan Anda di Tahun {{ $spp->tahun }} tidak tersedia.</p>
        </div>
        @endif
      </div>
      <!-- /.card-body -->
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="alert alert-danger" role="alert">
          ...
          <p>Status Pembayaran Tagihan Anda di Tahun {{ $spp->tahun }} tidak tersedia.</p>
        </div>
        @endif
      </div>
      <!-- /.card-body -->
