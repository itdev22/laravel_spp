...
<body>
    <br><br>
    <center>
        <h2 style="font-family: sans-serif;">History Pembayaran Permas</h2>
    </center>
    <br>
    ...
    <table style="" border="1" cellspacing="0" cellpadding="10" width="100%">
        <thead>
            <tr>
                ...
                <th scope="col" style="font-family: sans-serif;">Metode Bayar</th>
        ...
        <tbody>
            <tr>
                ...
                <td style="font-family: sans-serif;">{{ $pembayaran->status }}</td>
            </tr>
        </tbody>
    </table>
</body>
