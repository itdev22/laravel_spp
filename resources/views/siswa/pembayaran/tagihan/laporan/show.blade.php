...
<body>
    ...
    <div class="container">
        <center>
            ...
            <br>
            <h2 style="font-family: sans-serif;">Laporan Pembayaran Tagihan</h2><br><br>
    </center>
<body>
    <br><br>
    ...
    <table style="" border="1" cellspacing="0" cellpadding="10" width="100%">
        <thead>
            <tr>
                ...
                <th style="font-family: sans-serif;">Untuk Tagihan</th>
                <th style="font-family: sans-serif;">Metode</th>
        ...
        <tbody>
            @foreach ($pembayaran as $row)
                <tr>
                    ...
                    <td style="font-family: sans-serif;">{{ $row->metode }}</td>
