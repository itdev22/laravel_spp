...
<head>
    ...
    <style>
        ...
        .logo_sma {
            position: absolute;
            top: 3px; /* Ubah nilai top sesuai dengan posisi vertikal yang diinginkan */
            left: 1px; /* Ubah nilai left sesuai dengan posisi horizontal yang diinginkan */
            width: 120px;

        }
        .logo_dispen {
            position: absolute;
            top: 5px; /* Ubah nilai top sesuai dengan posisi vertikal yang diinginkan */
            right: 5px; /* Ubah nilai left sesuai dengan posisi horizontal yang diinginkan */
            width: 100px;
...
<body>
    ...
    <div class="container">
        <center>
        <h3 style="font-family: sans-serif; margin:auto;">PEMERINTAH PROVINSI JAWA TIMUR <br> <b>DINAS PENDIDIKAN <br>
            SEKOLAH MENENGAH ATAS NEGERI 4 KOTA KEDIRI</b> </h3>
            <h5 style="padding:0px; margin-top:auto;">JL. Sersan Suharmaji IX/52, Manisrenggo, Telp/Fax. (0354) 688864, KP.64128 Kediri
            <br> Website : http://.sman4-kdr.sch.id Email : sman4.info@gmail.com</h5><hr>

            <br> <h2 style="font-family: sans-serif;">Laporan Pembayaran Parmas</h2>
        </center>
    <br>
