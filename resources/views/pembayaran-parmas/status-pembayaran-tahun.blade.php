        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('parmas.pembayaran.status-pembayaran') }}" class="btn btn-danger btn-sm">
                ...
                <div class="card-body">
                    <div class="list-group">
                        @foreach ($spp as $row)
                            @if ($row->tahun == date('Y'))
                                <a href="{{ route('parmas.pembayaran.status-pembayaran.show-status', [$siswa->nisn, $row->tahun]) }}"
