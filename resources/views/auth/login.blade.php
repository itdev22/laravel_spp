...
<div class="login-box" style="margin-bottom: 20vh;">
  ...
  <a href="">
    <img src="{{ asset('templates/backend/AdminLTE-3.1.0') }}/dist/img/smapa.png"  height="80" width="80">
  </a>
  <!-- <a href=""><b>PARTISIPASI MASYARAKAT</b></a>  -->
  </div>

  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Partisipasi Masyarakat</p>
      @error('username')
