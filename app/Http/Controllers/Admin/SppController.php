...
class SppController extends Controller
{
    ...
    {
        $this->middleware(['permission:read-parmas'])->only(['index', 'show']);
        $this->middleware(['permission:create-parmas'])->only(['create', 'store']);
        $this->middleware(['permission:update-parmas'])->only(['edit', 'update']);
        $this->middleware(['permission:delete-parmas'])->only(['destroy']);
    }
